...
var swfobject = function () {
    ...
    function F() {
        ...
        if (b > 0)for (c = 0; b > c; c++)if (d = m[c].id, e = m[c].callbackFn, f = {success: !1, id: d}, y.pv[0] > 0) {
    ...
    function I(b, c, d, e) {
        ...
        u = !0, r = e || null, s = {
            success: !1,
            id: d
        }, g = P(d), g && ("OBJECT" == g.nodeName ? (p = K(g), q = null) : (p = g, q = d), b.id = f, (typeof b.width == a || !/%$/.test(b.width) && parseInt(b.width, 10) < 310) && (b.width = "310"), (typeof b.height == a || !/%$/.test(b.height) && parseInt(b.height, 10) < 137) && (b.height = "137"), i.title = i.title.slice(0, 47) + " - Flash Player Installation", j = y.ie && y.win ? "ActiveX" : "PlugIn", k = "MMredirectURL=" + h.location.toString().replace(/&/g, "%26") + "&MMplayerType=" + j + "&MMdoctitle=" + i.title, typeof c.flashvars != a ? c.flashvars += "&" + k : c.flashvars = k, y.ie && y.win && 4 != g.readyState && (l = Q("div"), d += "SWFObjectNew", l.setAttribute("id", d), g.parentNode.insertBefore(l, g), g.style.display = "none", function () {
    ...
    function K(a) {
        var d, e, f, g, c = Q("div");
        if (y.win && y.ie)c.innerHTML = a.innerHTML; else if (d = a.getElementsByTagName(b)[0], d && (e = d.childNodes))for (f = e.length, g = 0; f > g; g++)1 == e[g].nodeType && "PARAM" == e[g].nodeName || 8 == e[g].nodeType || c.appendChild(e[g].cloneNode(!0));
        return c
    }
    ...
    return function () {
        ...
        registerObject: function (a, b, c, d) {
            ...
            y.w3 && !(y.wk && y.wk < 312) && c && d && e && f && g ? (U(d, !1), B(function () {
                ...
                if (S(g))s = L(n, p, d), n.id == d && U(d, !0), m.success = !0, m.ref = s; else {
    ...
    var b = {
        init: function (b, d) {
            return this.each(function () {
                var i, j, k, l, m, n, e = a(this), f = e.clone(), g = a.extend({
                    id: e.attr("id"),
                    swf: "uploadify.swf",
                ...
                d && (h = a.extend(h, d)), h = a.extend(h, g), i = swfobject.getFlashPlayerVersion(), j = i.major >= 9, j ? (window["uploadify_" + g.id] = new SWFUpload(h), k = window["uploadify_" + g.id], e.data("uploadify", k), l = a("<div />", {
                    id: g.id,
                    "class": "uploadify",
                    css: {height: g.height + "px", width: g.width + "px"}
                }), a("#" + k.movieName).wrap(l), l = a("#" + g.id), l.data("uploadify", k), m = a("<div />", {
                    id: g.id + "-button",
                ...
                }), l.after(n), k.settings.queueID = g.id + "-queue", k.settings.defaultQueue = !0), k.queueData = {
                    files: {},
                    filesSelected: 0,
                    filesQueued: 0,
                    filesReplaced: 0,
                ...
                }, k.original = f, k.wrapper = l, k.button = m, k.queue = n, g.onInit && g.onInit.call(e, k)) : g.onFallback && g.onFallback.call(e)
            })
        }, cancel: function () {
            var d = arguments;
            this.each(function () {
                var g, h, i, b = a(this), c = b.data("uploadify"), e = c.settings, f = -1;
                if (d[0])if ("*" == d[0])g = c.queueData.queueLength, a("#" + e.queueID).find(".uploadify-queue-item").each(function () {
                ...
                }), c.queueData.queueSize = 0, c.queueData.queueLength = 0, e.onClearQueue && e.onClearQueue.call(b, g); else for (h = 0; h < d.length; h++)c.cancelUpload(d[h]), a("#" + d[h]).find(".data").removeClass("data").html(" - Cancelled"), a("#" + d[h]).find(".uploadify-progress-bar").remove(), a("#" + d[h]).delay(1e3 + 100 * h).fadeOut(500, function () {
                    a(this).remove()
                }); else i = a("#" + e.queueID).find(".uploadify-queue-item").get(0), $item = a(i), c.cancelUpload($item.attr("id")), $item.find(".data").removeClass("data").html(" - Cancelled"), $item.find(".uploadify-progress-bar").remove(), $item.delay(1e3).fadeOut(500, function () {
                    a(this).remove()
                })
            })
        }, destroy: function () {
            ...
            var e = arguments, f = c;
            return this.each(function () {
                var j, g = a(this), h = g.data("uploadify"), i = h.settings;
                if ("object" == typeof e[0])for (j in c)setData(j, c[j]);
            ...
            var b = arguments;
            this.each(function () {
                var e, c = a(this), d = c.data("uploadify");
                if (d.queueData.averageSpeed = 0, d.queueData.uploadSize = 0, d.queueData.bytesUploaded = 0, d.queueData.uploadQueue = [], b[0])if ("*" == b[0])d.queueData.uploadSize = d.queueData.queueSize, d.queueData.uploadQueue.push("*"), d.startUpload(); else {
                    for (e = 0; e < b.length; e++)d.queueData.uploadSize += d.queueData.files[b[e]].size, d.queueData.uploadQueue.push(b[e]);
        ...
        onDialogOpen: function () {
            var a = this.settings;
            this.queueData.errorMsg = "Some files were not added to the queue:", this.queueData.filesReplaced = 0, this.queueData.filesCancelled = 0, a.onDialogOpen && a.onDialogOpen.call(this)
            ...
            var e, f, g, h, i, j, k, c = this.settings, d = {};
            for (e in this.queueData.files)if (d = this.queueData.files[e], 1 != d.uploaded && d.name == b.name) {
                if (f = confirm('The file named "' + b.name + '" is already in the queue.\nDo you want to replace the existing item in the queue?'), !f)return this.cancelUpload(b.id), this.queueData.filesCancelled++, !1;
                a("#" + d.id).remove(), this.cancelUpload(d.id), this.queueData.filesReplaced++
            }
            if (g = Math.round(b.size / 1024), h = "KB", g > 1e3 && (g = Math.round(g / 1e3), h = "MB"), i = g.toString().split("."), g = i[0], i.length > 1 && (g += "." + i[1].substr(0, 2)), g += h, j = b.name, j.length > 25 && (j = j.substr(0, 25) + "..."), itemData = {
                    fileID: b.id,
                    instanceID: c.id,
                    fileName: j,
                    fileSize: g
                ...
                for (k in itemData)itemHTML = itemHTML.replace(new RegExp("\\$\\{" + k + "\\}", "g"), itemData[k]);
            ...
            if (this.queueData.queueLength = e.files_queued, "*" == this.queueData.uploadQueue[0] ? this.queueData.queueLength > 0 ? this.startUpload() : (this.queueData.uploadQueue = [], c.onQueueComplete && c.onQueueComplete.call(this, this.queueData)) : this.queueData.uploadQueue.length > 0 ? this.startUpload(this.queueData.uploadQueue.shift()) : (this.queueData.uploadQueue = [], c.onQueueComplete && c.onQueueComplete.call(this, this.queueData)), a.inArray("onUploadComplete", c.overrideEvents) < 0)if (c.removeCompleted)switch (b.filestatus) {
