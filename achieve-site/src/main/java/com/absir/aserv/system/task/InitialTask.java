...
public class InitialTask {
    ...
    protected void started() {
        if (Environment.isDevelop() || InitBeanFactory.ME.isInitCheck()) {
            JUserRole userRole = BeanDao.get(BeanDao.getSession(), JUserRole.class, 1L);
            if (userRole == null) {
                userRole = insertUserRole(1L, "系统管理员");
