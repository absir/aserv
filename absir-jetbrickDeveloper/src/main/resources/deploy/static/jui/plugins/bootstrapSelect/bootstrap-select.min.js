...
Object.keys || (Object.keys = function () {
    ...
    function f(b, c) {
        var g, h, d = arguments, f = b;
        return b = d[0], c = d[1], [].shift.apply(d), "undefined" == typeof b && (b = f), h = this.each(function () {
            var h, i, j, k, f = a(this);
            if (f.is("select")) {
                if (h = f.data("selectpicker"), i = "object" == typeof b && b, h) {
                    if (i)for (k in i)i.hasOwnProperty(k) && (h.options[k] = i[k])
                } else j = a.extend({}, e.DEFAULTS, a.fn.selectpicker.defaults || {}, f.data(), i), f.data("selectpicker", h = new e(this, j, c));
    ...
    a.expr[":"].icontains = function (c, d, e) {
        ...
        constructor: e, init: function () {
            ...
            return this.$element.find("option").each(function (c) {
                var p, q, r, d = a(this), i = d.attr("class") || "", j = d.attr("style"), k = d.data("content") ? d.data("content") : d.html(), l = "undefined" != typeof d.data("subtext") ? '<small class="muted text-muted">' + d.data("subtext") + "</small>" : "", m = "undefined" != typeof d.data("icon") ? '<span class="' + b.options.iconBase + " " + d.data("icon") + '"></span> ' : "", n = d.is(":disabled") || d.parent().is(":disabled"), o = c;
                "" !== m && n && (m = "<span>" + m + "</span>"), d.data("content") || (k = m + '<span class="text">' + k + l + "</span>"), b.options.hideDisabled && n || (d.parent().is("optgroup") && d.data("divider") !== !0 ? (0 === d.index() && (f += 1, p = d.parent().attr("label"), q = "undefined" != typeof d.parent().data("subtext") ? '<small class="muted text-muted">' + d.parent().data("subtext") + "</small>" : "", r = d.parent().data("icon") ? '<span class="' + b.options.iconBase + " " + d.parent().data("icon") + '"></span> ' : "", p = r + '<span class="text">' + p + q + "</span>", 0 !== o && e.length > 0 && e.push(g("", null, "divider")), e.push(g(p, null, "dropdown-header"))), e.push(g(h(k, "opt " + i, j, f), o))) : d.data("divider") === !0 ? e.push(g("", o, "divider")) : d.data("hidden") === !0 ? e.push(g(h(k, i, j), o, "hide is-hidden")) : e.push(g(h(k, i, j), o)))
            ...
            }), this.tabIndex(), e = this.options.hideDisabled ? ":not([disabled])" : "", f = this.$element.find("option:selected" + e).map(function () {
                var e, b = a(this), d = b.data("icon") && c.options.showIcon ? '<i class="' + c.options.iconBase + " " + b.data("icon") + '"></i> ' : "";
                return e = c.options.showSubtext && b.attr("data-subtext") && !c.multiple ? ' <small class="muted text-muted">' + b.data("subtext") + "</small>" : "", b.data("content") && c.options.showContent ? b.data("content") : "undefined" != typeof b.attr("title") ? b.attr("title") : d + b.html() + e
            }).toArray(), g = this.multiple ? f.join(this.options.multipleSeparator) : f[0], this.multiple && this.options.selectedTextFormat.indexOf("count") > -1 && (h = this.options.selectedTextFormat.split(">"), (h.length > 1 && f.length > h[1] || 1 == h.length && f.length >= 2) && (e = this.options.hideDisabled ? ", [disabled]" : "", i = this.$element.find("option").not('[data-divider="true"], [data-hidden="true"]' + e).length, j = "function" == typeof this.options.countSelectedText ? this.options.countSelectedText(f.length, i) : this.options.countSelectedText, g = j.replace("{0}", f.length.toString()).replace("{1}", i.toString()))), this.options.title = this.$element.attr("title"), "static" == this.options.selectedTextFormat && (g = this.options.title), g || (g = "undefined" != typeof this.options.title ? this.options.title : this.options.noneSelectedText), this.$button.attr("title", d(g)), this.$newElement.find(".filter-option").html(g)
            ...
            var e, f, b = this, c = "<div />", d = a(c), g = function (a) {
                d.addClass(a.attr("class").replace(/form-control/gi, "")).toggleClass("dropup", a.hasClass("dropup")), e = a.offset(), f = a.hasClass("dropup") ? 0 : a[0].offsetHeight, d.css({
                    top: e.top + f,
                    left: e.left,
            ...
            this.$newElement.on("click", function () {
                ...
                a(c.target).closest(b.$newElement).length < 1 && d.removeClass("open")
            })
            ...
            return this.$newElement.hasClass("readonly") ? !0 : this.$element.is(":disabled")
            ...
            this.$newElement.on("touchstart.dropdown", ".dropdown-menu", function (a) {
                ...
                var h, i, j, k, l, m, n, o, p, q, r, s, t, d = a(this), e = d.parent().data("originalIndex"), f = b.$element.val(), g = b.$element.prop("selectedIndex");
                b.multiple && c.stopPropagation(), c.preventDefault(), b.isDisabled() || d.parent().hasClass("disabled") || (h = b.$element.find("option"), i = h.eq(e), j = i.prop("selected"), k = i.parent("optgroup"), l = b.options.maxOptions, m = k.data("maxOptions") || !1, b.multiple ? (i.prop("selected", !j), b.setSelected(e, !j), d.blur(), (l !== !1 || m !== !1) && (n = l < h.filter(":selected").length, o = m < k.find("option:selected").length, (l && n || m && o) && (l && 1 == l ? (h.prop("selected", !1), i.prop("selected", !0), b.$menu.find(".selected").removeClass("selected"), b.setSelected(e, !0)) : m && 1 == m ? (k.find("option:selected").prop("selected", !1), i.prop("selected", !0), p = d.data("optgroup"), b.$menu.find(".selected").has('a[data-optgroup="' + p + '"]').removeClass("selected"), b.setSelected(e, !0)) : (q = "function" == typeof b.options.maxOptionsText ? b.options.maxOptionsText(l, m) : b.options.maxOptionsText, r = q[0].replace("{n}", l), s = q[1].replace("{n}", m), t = a('<div class="notify"></div>'), q[2] && (r = r.replace("{var}", q[2][l > 1 ? 0 : 1]), s = s.replace("{var}", q[2][m > 1 ? 0 : 1])), i.prop("selected", !1), b.$menu.append(t), l && n && (t.append(a("<div>" + r + "</div>")), b.$element.trigger("maxReached.bs.select")), m && o && (t.append(a("<div>" + s + "</div>")), b.$element.trigger("maxReachedGrp.bs.select")), setTimeout(function () {
                    b.setSelected(e, !1)
            ...
            var f, h, i, j, k, l, m, n, o, r, s, q, d = a(this), e = d.is("input") ? d.parent().parent() : d.parent(), g = e.data("this"), p = {
                32: " ",
                48: "0",
                49: "1",
                50: "2",
            ...
            "body" == this.options.container && (this.$newElement.find(this.$menu).length || (this.$menu.appendTo(this.$newElement), a("body").find("> .bootstrap-select:empty").remove()))
        }
    }, g = a.fn.selectpicker, a.fn.selectpicker = f, a.fn.selectpicker.Constructor = e, a.fn.selectpicker.noConflict = function () {
