define("echarts/chart/map", ["require", "../component/base", "./base", "zrender/shape/Text", "zrender/shape/Path", "zrender/shape/Circle", "zrender/shape/Rectangle", "zrender/shape/Line", "zrender/shape/Polygon", "zrender/shape/Ellipse", "../component/dataRange", "../component/roamController", "../config", "../util/ecData", "zrender/tool/util", "zrender/config", "zrender/tool/event", "../util/mapData/params", "../util/mapData/textFixed", "../util/mapData/geoCoord", "../util/projection/svg", "../util/projection/normal", "../chart"], function (e) {
    ...
    var n = e("../component/base"), i = e("./base"), a = e("zrender/shape/Text"), o = e("zrender/shape/Path"), s = e("zrender/shape/Circle"), r = e("zrender/shape/Rectangle"), l = e("zrender/shape/Line"), h = e("zrender/shape/Polygon"), m = e("zrender/shape/Ellipse");
    e("../component/dataRange"), e("../component/roamController");
    var V = e("../config"), U = e("../util/ecData"), d = e("zrender/tool/util"), p = e("zrender/config"), c = e("zrender/tool/event"), u = e("../util/mapData/params").params, y = e("../util/mapData/textFixed"), g = e("../util/mapData/geoCoord");
    return t.prototype = {
        type: V.CHART_TYPE_MAP, _buildShape: function () {
            var e = this.series;
            ...
            for (var f in s) {
                if (h[f] && "average" == h[f])for (var c in s[f])s[f][c].value = (s[f][c].value / s[f][c].seriesIndex.length).toFixed(l[f]) - 0;
                this._mapDataMap[f] = this._mapDataMap[f] || {}, this._mapDataMap[f].mapData ? this._mapDataCallback(f, s[f], r[f])(this._mapDataMap[f].mapData) : u[f.replace(/\|.*/, "")].getGeoJson && (this._specialArea[f] = u[f.replace(/\|.*/, "")].specialArea || this._specialArea[f], u[f.replace(/\|.*/, "")].getGeoJson(this._mapDataCallback(f, s[f], r[f])))
            }
            ...
            for (var n = e.replace(/^.*\|/, ""), i = t.features, a = 0, o = i.length; o > a; a++)if (i[a].properties && i[a].properties.name == n) {
                i = i[a], "United States of America" == n && i.geometry.coordinates.length > 1 && (i = {
                    ...
                    }, id: i.id, properties: i.properties, type: i.type
                });
                break
            }
            return {type: "FeatureCollection", features: [i]}
        }, _getProjectionData: function (e, t, n) {
            var i, a = this._mapDataMap[e].projection, o = [], s = this._mapDataMap[e].bbox || a.getBbox(t, this._specialArea[e]);
            i = this._mapDataMap[e].hasRoam ? this._mapDataMap[e].transform : this._getTransform(s, n, this._mapDataMap[e].rate);
            var r, l = this._mapDataMap[e].lastTransform || {scale: {}};
            i.left != l.left || i.top != l.top || i.scale.x != l.scale.x || i.scale.y != l.scale.y ? (r = a.geoJson2Path(t, i, this._specialArea[e]), l = d.clone(i)) : (i = this._mapDataMap[e].transform, r = this._mapDataMap[e].pathArray), this._mapDataMap[e].bbox = s, this._mapDataMap[e].transform = i, this._mapDataMap[e].lastTransform = l, this._mapDataMap[e].pathArray = r;
            ...
            if ("china" == e) {
                var p = this.geo2pos(e, g["南海诸岛"] || u["南海诸岛"].textCoord), c = i.scale.x / 10.5, b = [32 * c + p[0], 83 * c + p[1]];
                y["南海诸岛"] && (b[0] += y["南海诸岛"][0], b[1] += y["南海诸岛"][1]), o.push({
                    name: this._nameChange(e, "南海诸岛"),
                    path: u["南海诸岛"].getPath(p, c),
                    position: h,
                    textX: b[0],
                    textY: b[1]
                })
            ...
            var s = e("../util/projection/normal"), r = s.getBbox(n), l = this.geo2pos(t, [a.left, a.top]), h = this.geo2pos(t, [a.left + a.width, a.top + a.height]), m = Math.abs(h[0] - l[0]), V = Math.abs(h[1] - l[1]), U = r.width, d = r.height, p = m / .75 / U, c = V / d;
            p > c ? (p = .75 * c, m = U * p) : (c = p, p = .75 * c, V = d * c);
            var u = {OffsetLeft: l[0], OffsetTop: l[1], scale: {x: p, y: c}}, y = s.geoJson2Path(n, u);
            return this._getSingleProvince(t, y[0], o)
        }, _getSingleProvince: function (e, t, n) {
            var i, a = t.properties.name, o = y[a] || [0, 0];
            if (g[a])i = this.geo2pos(e, g[a]); else if (t.cp)i = [t.cp[0] + o[0], t.cp[1] + o[1]]; else {
                var s = this._mapDataMap[e].bbox;
                i = this.geo2pos(e, [s.left + s.width / 2, s.top + s.height / 2]), i[0] += o[0], i[1] += o[1]
            }
            return t.name = this._nameChange(e, a), t.position = n, t.textX = i[0], t.textY = i[1], t
        }, _getTransform: function (e, t, n) {
            var i, a, o, s, r, l, h, m = this.series, V = this.zr.getWidth(), U = this.zr.getHeight(), d = Math.round(.02 * Math.min(V, U));
            for (var p in t)i = m[p].mapLocation || {}, o = i.x || o, r = i.y || r, l = i.width || l, h = i.height || h;
            a = this.parsePercent(o, V), a = isNaN(a) ? d : a, s = this.parsePercent(r, U), s = isNaN(s) ? d : s, l = null == l ? V - a - 2 * d : this.parsePercent(l, V), h = null == h ? U - s - 2 * d : this.parsePercent(h, U);
            var c = e.width, u = e.height, y = l / n / c, g = h / u;
            ...
            return {left: a, top: s, width: l, height: h, baseScale: 1, scale: {x: y, y: g}}
        }, _buildMap: function (e, t, n, i) {
            for (var V, p, c, u, y, g, b, f, k, _, x, L = this.series, W = this.component.legend, X = this.component.dataRange, K = this.ecTheme.map, w = 0, I = t.length; I > w; w++) {
                if (f = d.clone(t[w]), k = {
                        name: f.name,
                        path: f.path,
                        position: d.clone(f.position)
                    }, p = f.name, c = n[p]) {
                    y = [c], V = "";
                    for (var v = 0, J = c.seriesIndex.length; J > v; v++)y.push(L[c.seriesIndex[v]]), V += L[c.seriesIndex[v]].name + " ", W && this._showLegendSymbol[e] && W.hasColor(L[c.seriesIndex[v]].name) && this.shapeList.push(new s({
                        ...
                        style: {
                            ...
                            y: f.textY - 10,
                            r: 3,
                            color: W.getColor(L[c.seriesIndex[v]].name)
                        },
                        hoverable: !1
                    }));
                    y.push(K), u = c.value
                ...
                switch (g = X && !isNaN(u) ? X.getColor(u) : null, f.color = f.color || g || this.getItemStyleColor(this.deepQuery(y, "itemStyle.normal.color"), c.seriesIndex, -1, c) || this.deepQuery(y, "itemStyle.normal.areaStyle.color"), f.strokeColor = f.strokeColor || this.deepQuery(y, "itemStyle.normal.borderColor"), f.lineWidth = f.lineWidth || this.deepQuery(y, "itemStyle.normal.borderWidth"), k.color = this.getItemStyleColor(this.deepQuery(y, "itemStyle.emphasis.color"), c.seriesIndex, -1, c) || this.deepQuery(y, "itemStyle.emphasis.areaStyle.color") || f.color, k.strokeColor = this.deepQuery(y, "itemStyle.emphasis.borderColor") || f.strokeColor, k.lineWidth = this.deepQuery(y, "itemStyle.emphasis.borderWidth") || f.lineWidth, f.brushType = k.brushType = f.brushType || "both", f.lineJoin = k.lineJoin = "round", f._name = k._name = p, b = this.deepQuery(y, "itemStyle.normal.label.textStyle"), x = {
                    ...
                    style: {
                        ...
                        x: f.textX,
                        y: f.textY,
                        text: this.getLabelText(p, u, y, "normal"),
                        _name: p,
                        textAlign: "center",
                        color: this.deepQuery(y, "itemStyle.normal.label.show") ? this.deepQuery(y, "itemStyle.normal.label.textStyle.color") : "rgba(0,0,0,0)",
                        textFont: this.getFont(b)
                    }
                }, x._style = d.clone(x.style), x.highlightStyle = d.clone(x.style), this.deepQuery(y, "itemStyle.emphasis.label.show") ? (x.highlightStyle.text = this.getLabelText(p, u, y, "emphasis"), x.highlightStyle.color = this.deepQuery(y, "itemStyle.emphasis.label.textStyle.color") || x.style.color, b = this.deepQuery(y, "itemStyle.emphasis.label.textStyle") || b, x.highlightStyle.textFont = this.getFont(b)) : x.highlightStyle.color = "rgba(0,0,0,0)", _ = {
                    ...
                    _style: d.clone(f),
                    _mapType: e
                }, null != f.scale && (_.scale = d.clone(f.scale)), x = new a(x), _.style.shapeType) {
                    case"rectangle":
                        _ = new r(_);
                        break;
                    case"line":
                    ...
                    case"ellipse":
                        ...
                        break;
                    default:
                        _ = new o(_), _.buildPathArray && (_.style.pathArray = _.buildPathArray(_.style.path))
                }
                (this._selectedMode[e] && this._selected[p] || c.selected && this._selected[p] !== !1) && (x.style = x.highlightStyle, _.style = _.highlightStyle), x.clickable = _.clickable = this._clickable[e] && (null == c.clickable || c.clickable), this._selectedMode[e] && (this._selected[p] = null != this._selected[p] ? this._selected[p] : c.selected, this._mapTypeMap[p] = e, (null == c.selectable || c.selectable) && (_.clickable = x.clickable = !0, _.onclick = x.onclick = this.shapeHandler.onclick)), this._hoverable[e] && (null == c.hoverable || c.hoverable) ? (x.hoverable = _.hoverable = !0, _.hoverConnect = x.id, x.hoverConnect = _.id) : x.hoverable = _.hoverable = !1, U.pack(x, {
                    name: V,
                    tooltip: this.deepQuery(y, "tooltip")
                }, 0, c, 0, p), this.shapeList.push(x), U.pack(_, {
                    name: V,
                    tooltip: this.deepQuery(y, "tooltip")
                }, 0, c, 0, p), this.shapeList.push(_)
            }
            ...
            if (!(this.shapeList.length <= 0)) {
                var t, n, i = e.event, a = c.getX(i), o = c.getY(i), s = c.getDelta(i), r = e.mapTypeControl;
                r || (r = {}, n = this._findMapTypeByPos(a, o), n && this._roamMap[n] && "move" != this._roamMap[n] && (r[n] = !0));
                var l = !1;
                for (n in r)if (r[n]) {
                    l = !0;
                    var h = this._mapDataMap[n].transform, m = h.left, U = h.top, d = h.width, p = h.height, u = this.pos2geo(n, [a - m, o - U]);
                    if (s > 0) {
            ...
            if (!(this.shapeList.length <= 0)) {
                var t = e.target;
                if (!t || !t.draggable) {
                    var n = e.event, i = c.getX(n), a = c.getY(n), o = this._findMapTypeByPos(i, a);
                    if (o && this._roamMap[o] && "scale" != this._roamMap[o]) {
                        this._mousedown = !0, this._mx = i, this._my = a, this._curMapType = o, this.zr.on(p.EVENT.MOUSEUP, this._onmouseup);
                        var s = this;
                        setTimeout(function () {
            ...
            if (this._mousedown && this._isAlive) {
                var t = e.event, n = c.getX(t), i = c.getY(t), a = this._mapDataMap[this._curMapType].transform;
                a.hasRoam = !0, a.left -= this._mx - n, a.top -= this._my - i, this._mx = n, this._my = i, this._mapDataMap[this._curMapType].transform = a;
                for (var o = 0, s = this.shapeList.length; s > o; o++)this.shapeList[o]._mapType == this._curMapType && (this.shapeList[o].position[0] = a.left, this.shapeList[o].position[1] = a.top, this.zr.modShape(this.shapeList[o].id));
                this.messageCenter.dispatch(V.EVENT.MAP_ROAM, e.event, {type: "move"}, this.myChart), this.clearEffectShape(!0), this.zr.refresh(), this._justMove = !0, c.stop(t)
            }
        }, __onmouseup: function (e) {
            var t = e.event;
            this._mx = c.getX(t), this._my = c.getY(t), this._mousedown = !1;
            var n = this;
            setTimeout(function () {
            ...
            var n = e.mapTypeControl, i = 0, a = 0, o = e.step;
            switch (e.roamType) {
                case"scaleUp":
            ...
            for (var l = 0, h = this.shapeList.length; h > l; l++)r = this.shapeList[l]._mapType, n[r] && this._activeMapType[r] && (s = this._mapDataMap[r].transform, this.shapeList[l].position[0] = s.left, this.shapeList[l].position[1] = s.top, this.zr.modShape(this.shapeList[l].id));
            this.messageCenter.dispatch(V.EVENT.MAP_ROAM, e.event, {type: "move"}, this.myChart), this.clearEffectShape(!0), this.zr.refresh(), clearTimeout(this.dircetionTimer);
            var m = this;
            this.dircetionTimer = setTimeout(function () {
                m.animationEffect()
            }, 150)
        }, __ondrhoverlink: function (e) {
            for (var t, n, i = 0, a = this.shapeList.length; a > i; i++)t = this.shapeList[i]._mapType, this._hoverLinkMap[t] && this._activeMapType[t] && (n = U.get(this.shapeList[i], "value"), null != n && n >= e.valueMin && n <= e.valueMax && this.zr.addHoverShape(this.shapeList[i]))
        }, onclick: function (e) {
            if (this.isClick && e.target && !this._justMove && "icon" != e.target.type) {
                this.isClick = !1;
                var t = e.target, n = t.style._name, i = this.shapeList.length, a = t._mapType || "";
                ...
                this.messageCenter.dispatch(V.EVENT.MAP_SELECTED, e.event, {
            ...
            this._isAlive = !1, this.zr.un(p.EVENT.MOUSEWHEEL, this._onmousewheel), this.zr.un(p.EVENT.MOUSEDOWN, this._onmousedown), this.messageCenter.unbind(V.EVENT.ROAMCONTROLLER, this._onroamcontroller), this.messageCenter.unbind(V.EVENT.DATA_RANGE_HOVERLINK, this._ondrhoverlink)
        }
    }, d.inherits(t, i), d.inherits(t, n), e("../chart").define("map", t), t
}), define("zrender/shape/Path", ["require", "./Base", "./util/PathProxy", "../tool/util"], function (e) {
    var t = e("./Base"), n = e("./util/PathProxy"), i = n.PathSegment, a = function (e) {
    ...
    return r.prototype = {
        type: "path", buildPathArray: function (e, t, n) {
            ...
            var r = a.split("|"), l = [], h = 0, m = 0;
            for (s = 1; s < r.length; s++) {
                var V = r[s], U = V.charAt(0);
            ...
            var V = m * (Math.PI / 180), U = Math.cos(V) * (e - n) / 2 + Math.sin(V) * (t - i) / 2, d = -1 * Math.sin(V) * (e - n) / 2 + Math.cos(V) * (t - i) / 2, p = U * U / (l * l) + d * d / (h * h);
            p > 1 && (l *= Math.sqrt(p), h *= Math.sqrt(p));
            var c = Math.sqrt((l * l * h * h - l * l * d * d - h * h * U * U) / (l * l * d * d + h * h * U * U));
            a === r && (c *= -1), isNaN(c) && (c = 0);
            var u = c * l * d / h, y = c * -h * U / l, g = (e + n) / 2 + Math.cos(V) * u - Math.sin(V) * y, b = (t + i) / 2 + Math.sin(V) * u + Math.cos(V) * y, f = s([1, 0], [(U - u) / l, (d - y) / h]), k = [(U - u) / l, (d - y) / h], _ = [(-1 * U - u) / l, (-1 * d - y) / h], x = s(k, _);
            return o(k, _) <= -1 && (x = Math.PI), o(k, _) >= 1 && (x = 0), 0 === r && x > 0 && (x -= 2 * Math.PI), 1 === r && 0 > x && (x += 2 * Math.PI), [g, b, l, h, f, x, V, r]
        }, buildPath: function (e, t) {
            var n = t.path, i = t.x || 0, a = t.y || 0;
            t.pathArray = t.pathArray || this.buildPathArray(n, i, a);
            for (var o = t.pathArray, s = t.pointList = [], r = [], l = 0, h = o.length; h > l; l++) {
            ...
            for (var n = Number.MAX_VALUE, i = Number.MIN_VALUE, a = Number.MAX_VALUE, o = Number.MIN_VALUE, s = e.x || 0, r = e.y || 0, l = e.pathArray || this.buildPathArray(e.path), h = 0; h < l.length; h++)for (var m = l[h].points, V = 0; V < m.length; V++)V % 2 === 0 ? (m[V] + s < n && (n = m[V]), m[V] + s > i && (i = m[V])) : (m[V] + r < a && (a = m[V]), m[V] + r > o && (o = m[V]));
            var U;
    ...
    return n.prototype = {
        type: "ellipse", buildPath: function (e, t) {
            var n = .5522848, i = t.x, a = t.y, o = t.a, s = t.b, r = o * n, l = s * n;
            e.moveTo(i - o, a), e.bezierCurveTo(i - o, a - l, i - r, a - s, i, a - s), e.bezierCurveTo(i + r, a - s, i + o, a - l, i + o, a), e.bezierCurveTo(i + o, a + l, i + r, a + s, i, a + s), e.bezierCurveTo(i - r, a + s, i - o, a + l, i - o, a), e.closePath()
        }, getRect: function (e) {
            if (e.__rect)return e.__rect;
            var t;
    ...
    var n = e("./base"), i = e("zrender/shape/Text"), a = e("zrender/shape/Rectangle"), o = e("../util/shape/HandlePolygon"), s = e("../config"), r = e("zrender/tool/util"), l = e("zrender/tool/event"), h = e("zrender/tool/area"), m = e("zrender/tool/color");
    return t.prototype = {
        type: s.COMPONENT_TYPE_DATARANGE, _textGap: 10, _buildShape: function () {
            ...
            var e, t, n, o, s = this._valueTextList, r = s.length, l = this.getFont(this.dataRangeOption.textStyle), m = this._itemGroupLocation.x, V = this._itemGroupLocation.y, U = this.dataRangeOption.itemWidth, d = this.dataRangeOption.itemHeight, p = this.dataRangeOption.itemGap, c = h.getTextHeight("国", l);
            ...
            for (var y = 0; r > y; y++)e = s[y], o = this.getColorByIndex(y), t = this._getItemShape(m, V, U, d, this._selectedMap[y] ? o : "#ccc"), t._idx = y, t.onmousemove = this._dispatchHoverLink, t.onclick = this._dataRangeSelected, this.shapeList.push(new a(t)), u && (n = {
                zlevel: this._zlevelBase,
                style: {
                    x: m + U + 5,
                    y: V,
                ...
                clickable: !0
            }, "vertical" == this.dataRangeOption.orient && "right" == this.dataRangeOption.x && (n.style.x -= U + 10, n.style.textAlign = "right"), n._idx = y, n.onclick = this._dataRangeSelected, this.shapeList.push(new i(n))), "horizontal" == this.dataRangeOption.orient ? m += U + (u ? 5 : 0) + (u ? h.getTextWidth(e, l) : 0) + p : V += d + p;
            ...
            var t, n, o = this.getFont(this.dataRangeOption.textStyle), s = this._itemGroupLocation.x, r = this._itemGroupLocation.y, l = this.dataRangeOption.itemWidth, m = this.dataRangeOption.itemHeight, V = h.getTextHeight("国", o), U = !0;
            this.dataRangeOption.text && (U = !1, this.dataRangeOption.text[0] && (n = this._getTextShape(s, r, this.dataRangeOption.text[0]), "horizontal" == this.dataRangeOption.orient ? s += h.getTextWidth(this.dataRangeOption.text[0], o) + this._textGap : (r += V + this._textGap, n.style.y += V / 2 + this._textGap, n.style.textBaseline = "bottom"), this.shapeList.push(new i(n))));
            for (var d = e("zrender/tool/color"), p = 1 / (this.dataRangeOption.color.length - 1), c = [], u = 0, y = this.dataRangeOption.color.length; y > u; u++)c.push([u * p, this.dataRangeOption.color[u]]);
            "horizontal" == this.dataRangeOption.orient ? (t = {
                zlevel: this._zlevelBase,
                style: {x: s, y: r, width: 10 * l, height: m, color: d.getLinearGradient(s, r, s + 10 * l, r, c)},
                hoverable: !1
            }, s += 10 * l + this._textGap) : (t = {
                zlevel: this._zlevelBase,
                style: {x: s, y: r, width: l, height: 10 * m, color: d.getLinearGradient(s, r, s, r + 10 * m, c)},
                hoverable: !1
            }, r += 10 * m + this._textGap), this.shapeList.push(new a(t)), this._calculableLocation = t.style, this.dataRangeOption.calculable && (this._buildFiller(), this._bulidMask(), this._bulidHandle()), this._buildIndicator(), !U && this.dataRangeOption.text[1] && (n = this._getTextShape(s, r, this.dataRangeOption.text[1]), this.shapeList.push(new i(n)))
        }, _buildIndicator: function () {
            var e, t, n = this._calculableLocation.x, i = this._calculableLocation.y, a = this._calculableLocation.width, s = this._calculableLocation.height, r = 5;
            "horizontal" == this.dataRangeOption.orient ? "bottom" != this.dataRangeOption.y ? (e = [[n, i + s], [n - r, i + s + r], [n + r, i + s + r]], t = "bottom") : (e = [[n, i], [n - r, i - r], [n + r, i - r]], t = "top") : "right" != this.dataRangeOption.x ? (e = [[n + a, i], [n + a + r, i - r], [n + a + r, i + r]], t = "right") : (e = [[n, i], [n - r, i - r], [n - r, i + r]], t = "left"), this._indicatorShape = {
                style: {
                    pointList: e,
                    color: "#fff",
                    __rect: {
            ...
            var e, t, n, i, a, s, r, l, m = this._calculableLocation.x, V = this._calculableLocation.y, U = this._calculableLocation.width, d = this._calculableLocation.height, p = this.getFont(this.dataRangeOption.textStyle), c = h.getTextHeight("国", p), u = Math.max(h.getTextWidth(this._textFormat(this.dataRangeOption.max), p), h.getTextWidth(this._textFormat(this.dataRangeOption.min), p)) + 2;
            ...
            var e = this._valueTextList, t = e.length, n = this.dataRangeOption.itemGap, i = this.dataRangeOption.itemWidth, a = this.dataRangeOption.itemHeight, o = 0, s = 0, r = this.getFont(this.dataRangeOption.textStyle), l = h.getTextHeight("国", r);
            if ("horizontal" == this.dataRangeOption.orient) {
                if (this.dataRangeOption.text || this.dataRangeOption.splitNumber <= 0 || this.dataRangeOption.calculable)o = (this.dataRangeOption.splitNumber <= 0 || this.dataRangeOption.calculable ? 10 * i + n : t * (i + n)) + (this.dataRangeOption.text && "undefined" != typeof this.dataRangeOption.text[0] ? h.getTextWidth(this.dataRangeOption.text[0], r) + this._textGap : 0) + (this.dataRangeOption.text && "undefined" != typeof this.dataRangeOption.text[1] ? h.getTextWidth(this.dataRangeOption.text[1], r) + this._textGap : 0); else {
                    i += 5;
                    for (var m = 0; t > m; m++)o += i + h.getTextWidth(e[m], r) + n
                }
                o -= n, s = Math.max(l, a)
            } else {
                var V;
                if (this.dataRangeOption.text || this.dataRangeOption.splitNumber <= 0 || this.dataRangeOption.calculable)s = (this.dataRangeOption.splitNumber <= 0 || this.dataRangeOption.calculable ? 10 * a + n : t * (a + n)) + (this.dataRangeOption.text && "undefined" != typeof this.dataRangeOption.text[0] ? this._textGap + l : 0) + (this.dataRangeOption.text && "undefined" != typeof this.dataRangeOption.text[1] ? this._textGap + l : 0), V = Math.max(h.getTextWidth(this.dataRangeOption.text && this.dataRangeOption.text[0] || "", r), h.getTextWidth(this.dataRangeOption.text && this.dataRangeOption.text[1] || "", r)), o = Math.max(i, V); else {
                    s = (a + n) * t, i += 5, V = 0;
                    for (var m = 0; t > m; m++)V = Math.max(V, h.getTextWidth(e[m], r));
                    o = i + V
                }
                s -= n
            }
            var U, d = this.reformCssArray(this.dataRangeOption.padding), p = this.zr.getWidth();
            switch (this.dataRangeOption.x) {
                case"center":
                    U = Math.floor((p - o) / 2);
                    break;
                case"left":
                    U = d[3] + this.dataRangeOption.borderWidth;
                    break;
                case"right":
                    U = p - o - d[1] - this.dataRangeOption.borderWidth;
                    break;
                default:
                    U = this.parsePercent(this.dataRangeOption.x, p), U = isNaN(U) ? 0 : U
            }
            var c, u = this.zr.getHeight();
            switch (this.dataRangeOption.y) {
                case"top":
                    c = d[0] + this.dataRangeOption.borderWidth;
                    break;
                case"bottom":
                    c = u - s - d[2] - this.dataRangeOption.borderWidth;
                    break;
                case"center":
                    c = Math.floor((u - s) / 2);
                    break;
                default:
                    c = this.parsePercent(this.dataRangeOption.y, u), c = isNaN(c) ? 0 : c
            }
            if (this.dataRangeOption.calculable) {
                var y = Math.max(h.getTextWidth(this.dataRangeOption.max, r), h.getTextWidth(this.dataRangeOption.min, r)) + l;
                "horizontal" == this.dataRangeOption.orient ? (y > U && (U = y), U + o + y > p && (U -= y)) : (l > c && (c = l), c + s + l > u && (c -= l))
            }
            return {x: U, y: c, width: o, height: s}
            ...
            var i = this._calculableLocation.x, a = this._calculableLocation.y, o = this._calculableLocation.width, s = this._calculableLocation.height;
            return "horizontal" == this.dataRangeOption.orient ? e.style.x + t <= i ? e.style.x = i : e.style.x + t + e.style.width >= i + o ? e.style.x = i + o - e.style.width : e.style.x += t : e.style.y + n <= a ? e.style.y = a : e.style.y + n + e.style.height >= a + s ? e.style.y = a + s - e.style.height : e.style.y += n, "filler" == e._type ? this._syncHandleShape() : this._syncFillerShape(e), this.dataRangeOption.realtime && this._syncData(), !0
            ...
            this.messageCenter.dispatch(s.EVENT.DATA_RANGE_HOVERLINK, e.event, {valueMin: t, valueMax: n}, this.myChart)
    ...
    }, r.inherits(t, n), e("../component").define("dataRange", t), t
    ...
    var n = e("./base"), i = e("zrender/shape/Rectangle"), a = e("zrender/shape/Sector"), o = e("zrender/shape/Circle"), s = e("../config"), r = e("zrender/tool/util"), l = e("zrender/tool/color"), h = e("zrender/tool/event");
    return t.prototype = {
        type: s.COMPONENT_TYPE_ROAMCONTROLLER, _buildShape: function () {
            ...
            var t = this._itemGroupLocation.r, n = this._itemGroupLocation.x + t, i = this._itemGroupLocation.y + t, o = {
                zlevel: this._zlevelBase,
                style: {
                    x: n,
                    y: i,
            ...
            n = 0 > n ? 20 : n;
            var i = Math.min(t / 2 - 5, n) / 2, a = this._itemGroupLocation.x + ("scaleDown" === e ? t - i : i), s = this._itemGroupLocation.y + this._itemGroupLocation.height - i, r = {
                zlevel: this._zlevelBase,
                style: {
                    x: a,
                    y: s,
            ...
            return r = new o(r), r._roamType = e, r.onmousedown = this._scaleHandler, r
        }, _buildBackground: function () {
            ...
            var e, t = this.reformCssArray(this.rcOption.padding), n = this.rcOption.width, i = this.rcOption.height, a = this.zr.getWidth(), o = this.zr.getHeight();
    ...
    }, r.inherits(t, n), e("../component").define("roamController", t), t
}), define("echarts/util/mapData/params", ["require"], function (e) {
    function t(e) {
        if (!e.UTF8Encoding)return e;
        for (var t = e.features, i = 0; i < t.length; i++)for (var a = t[i], o = a.geometry.coordinates, s = a.geometry.encodeOffsets, r = 0; r < o.length; r++) {
            var l = o[r];
            if ("Polygon" === a.geometry.type)o[r] = n(l, s[r]); else if ("MultiPolygon" === a.geometry.type)for (var h = 0; h < l.length; h++) {
                var m = l[h];
                l[h] = n(m, s[r][h])
            }
        }
    ...
    function n(e, t) {
        for (var n = [], i = t[0], a = t[1], o = 0; o < e.length; o += 2) {
            var s = e.charCodeAt(o) - 64, r = e.charCodeAt(o + 1) - 64;
            s = s >> 1 ^ -(1 & s), r = r >> 1 ^ -(1 & r), s += i, r += a, i = s, a = r, n.push([s / 1024, r / 1024])
        }
        return n
    }
        ...
        none: {
            ...
            textCoord: [126, 25], getPath: function (e, t) {
                for (var n = [[[0, 3.5], [7, 11.2], [15, 11.9], [30, 7], [42, .7], [52, .7], [56, 7.7], [59, .7], [64, .7], [64, 0], [5, 0], [0, 3.5]], [[13, 16.1], [19, 14.7], [16, 21.7], [11, 23.1], [13, 16.1]], [[12, 32.2], [14, 38.5], [15, 38.5], [13, 32.2], [12, 32.2]], [[16, 47.6], [12, 53.2], [13, 53.2], [18, 47.6], [16, 47.6]], [[6, 64.4], [8, 70], [9, 70], [8, 64.4], [6, 64.4]], [[23, 82.6], [29, 79.8], [30, 79.8], [25, 82.6], [23, 82.6]], [[37, 70.7], [43, 62.3], [44, 62.3], [39, 70.7], [37, 70.7]], [[48, 51.1], [51, 45.5], [53, 45.5], [50, 51.1], [48, 51.1]], [[51, 35], [51, 28.7], [53, 28.7], [53, 35], [51, 35]], [[52, 22.4], [55, 17.5], [56, 17.5], [53, 22.4], [52, 22.4]], [[58, 12.6], [62, 7], [63, 7], [60, 12.6], [58, 12.6]], [[0, 3.5], [0, 93.1], [64, 93.1], [64, 0], [63, 0], [63, 92.4], [1, 92.4], [1, 3.5], [0, 3.5]]], i = "", a = e[0], o = e[1], s = 0, r = n.length; r > s; s++) {
                    ...
                    for (var l = 1, h = n[s].length; h > l; l++)i += "L " + ((n[s][l][0] * t + a).toFixed(2) - 0) + " " + ((n[s][l][1] * t + o).toFixed(2) - 0) + " "
                }
                return i + " Z"
            }
        }, "新疆": {
    ...
    function n(e) {
        ...
        var i = t(n.getAttribute("x")), a = t(n.getAttribute("y")), o = t(n.getAttribute("width")), s = t(n.getAttribute("height"));
    ...
    function i(e, t) {
        function n(e) {
            ...
            if (m[t]) {
                var o = m[t](e, i);
                o && (o.scale = i, o.properties = {name: e.getAttribute("name") || ""}, o.id = e.id, r(o, e), a.push(o))
            }
            for (var s = e.childNodes, l = 0, h = s.length; h > l; l++)n(s[l])
        }

        var i = [t.scale.x, t.scale.y], a = [];
        return n(e), a
    }
    ...
    function r(e, t) {
        var n = t.getAttribute("fill"), i = t.getAttribute("stroke"), a = t.getAttribute("stroke-width"), o = t.getAttribute("opacity");
    ...
    function l(e) {
        for (var t = s(e).replace(/,/g, " ").split(/\s+/), n = [], i = 0; i < t.length;) {
            var a = parseFloat(t[i++]), o = parseFloat(t[i++]);
            n.push([a, o])
        }
        return n
    }
    ...
    var h = e("zrender/shape/Path"), m = {
        path: function (e, t) {
            var n = e.getAttribute("d"), i = h.prototype.getRect({path: n});
            return {shapeType: "path", path: n, cp: [(i.x + i.width / 2) * t[0], (i.y + i.height / 2) * t[1]]}
        }, rect: function (e, n) {
            var i = t(e.getAttribute("x")), a = t(e.getAttribute("y")), o = t(e.getAttribute("width")), s = t(e.getAttribute("height"));
            return {
                shapeType: "rectangle",
                x: i,
                y: a,
            ...
            var i = t(e.getAttribute("x1")), a = t(e.getAttribute("y1")), o = t(e.getAttribute("x2")), s = t(e.getAttribute("y2"));
            return {
                shapeType: "line",
                xStart: i,
                yStart: a,
            ...
            var i = t(e.getAttribute("cx")), a = t(e.getAttribute("cy")), o = t(e.getAttribute("r"));
            return {shapeType: "circle", x: i, y: a, r: o, cp: [i * n[0], a * n[1]]}
        }, ellipse: function (e, t) {
            var n = parseFloat(e.getAttribute("cx") || 0), i = parseFloat(e.getAttribute("cy") || 0), a = parseFloat(e.getAttribute("rx") || 0), o = parseFloat(e.getAttribute("ry") || 0);
            return {shapeType: "ellipse", x: n, y: i, a: a, b: o, cp: [n * t[0], i * t[1]]}
        }, polygon: function (e, t) {
            var n = e.getAttribute("points"), i = [1 / 0, 1 / 0], a = [-1 / 0, -1 / 0];
            if (n) {
                n = l(n);
                for (var o = 0; o < n.length; o++) {
                    var s = n[o];
                    i[0] = Math.min(s[0], i[0]), i[1] = Math.min(s[1], i[1]), a[0] = Math.max(s[0], a[0]), a[1] = Math.max(s[1], a[1])
                }
                return {shapeType: "polygon", pointList: n, cp: [(i[0] + a[0]) / 2 * t[0], (i[1] + a[1]) / 2 * t[0]]}
            }
    ...
    function t(e, t) {
        t = t || {}, s.xmin = 360, s.xmax = -360, s.ymin = 180, s.ymax = -180;
        for (var n, i, a = e.features, o = 0, r = a.length; r > o; o++)if (i = a[o], !i.properties.name || !t[i.properties.name])switch (i.type) {
            case"Feature":
                s[i.geometry.type](i.geometry.coordinates);
                break;
            case"GeometryCollection":
                n = i.geometries;
                for (var l = 0, h = n.length; h > l; l++)s[n[l].type](n[l].coordinates)
        }
        return e.srcSize = {
    ...
    function n(e, n, i) {
        ...
        for (var s, r, l, h = e.features, m = [], V = 0, U = h.length; U > V; V++)if (l = h[V], !l.properties.name || !i[l.properties.name])if ("Feature" == l.type)a(l.geometry, l); else if ("GeometryCollection" == l.type) {
            s = l.geometries;
            for (var d = 0, p = s.length; p > d; d++)r = s[d], a(r, r)
        }
        var c, u, y;
        return m
    }
    ...
    var o = {
        formatPoint: function (e) {
            ...
            var i = (n[0] - o.offset.x) * o.scale.x + o.offset.left, a = (n[1] - o.offset.y) * o.scale.y + o.offset.top;
            return [i, a]
        }, Point: function (e) {
        ...
        formatPoint: o.formatPoint, makePoint: function (e) {
            var t = this, n = t.formatPoint(e), i = n[0], a = n[1];
    ...
    var n = e("zrender/shape/Base"), i = e("zrender/shape/Polygon"), a = e("zrender/tool/util");
    return t.prototype = {
