define("echarts/chart/force", ["require", "../component/base", "./base", "../data/Graph", "../layout/Force", "zrender/shape/Line", "zrender/shape/BezierCurve", "zrender/shape/Image", "../util/shape/Icon", "../config", "../util/ecData", "zrender/tool/util", "zrender/config", "zrender/tool/vector", "../chart"], function (e) {
    ...
    var s = e("../component/base"), r = e("./base"), l = e("../data/Graph"), h = e("../layout/Force"), d = e("zrender/shape/Line"), c = e("zrender/shape/BezierCurve"), p = e("zrender/shape/Image"), m = e("../util/shape/Icon"), u = e("../config"), g = e("../util/ecData"), V = e("zrender/tool/util"), y = e("zrender/config"), U = e("zrender/tool/vector");
    return t.prototype = {
        constructor: t, type: u.CHART_TYPE_FORCE, _init: function () {
            ...
            for (var o = e.data || e.nodes, a = 0; a < o.length; a++) {
                ...
                var d = this._getNodeCategory(e, r), c = d ? d.name : r.name;
                if (this.selectedMap[c] = this.isSelected(c), this.selectedMap[c])t.push(s), i++; else {
                    n.splice(i, 1);
            ...
            for (var t = new l(!0), i = e.data || e.nodes, n = 0, a = i.length; a > n; n++) {
                var o = i[n];
                if (o && !o.ignore) {
                    var s = this._getNodeCategory(e, o), r = s ? s.name : o.name;
            ...
            for (var l = 0; i > l; l++) {
                var h = t.nodes[l];
                if ("undefined" != typeof this.__nodePositionMap[h.id])h.layout.position = U.create(), U.copy(h.layout.position, this.__nodePositionMap[h.id]); else if ("undefined" != typeof h.data.initial)h.layout.position = U.create(), U.copy(h.layout.position, h.data.initial); else {
                    var c = this._layout.center, p = Math.min(this._layout.width, this._layout.height);
                    h.layout.position = o(c[0], c[1], .8 * p)
                }
                var m = h.shape.style, u = h.layout.size;
            ...
            i.eachNode(function (i) {
                var a = this._getNodeCategory(e, i.data), o = [i.data, a, e], s = this._getNodeQueryTarget(e, i.data), r = this._getNodeQueryTarget(e, i.data, "emphasis"), l = new m({
                    style: {
                        x: 0,
                        y: 0,
            ...
            for (var i = this._graph, n = i.edges.length, a = 0; n > a; a++) {
                var o = i.edges[a], s = o.data, r = o.node1, l = o.node2, h = this._getEdgeQueryTarget(e, o), p = this.deepQuery(h, "type");
                e.linkSymbol && "none" !== e.linkSymbol && (p = "line");
                var u = "line" === p ? d : c, y = new u({
            ...
            for (var e = U.create(), t = this._graph.edges, i = 0, n = t.length; n > i; i++) {
                var a = t[i], o = a.node1.shape, s = a.node2.shape, r = o.position, l = s.position;
            ...
            for (var e = this._graph, t = 0; t < e.nodes.length; t++) {
                var i = e.nodes[t], n = i.layout.position, a = i.data, o = i.shape;
    ...
    return i.Node = n, i.Edge = a, i.fromMatrix = function (e, t, n) {
        if (t && t.length && t[0].length === t.length && e.length === t.length) {
            ...
            for (var s = 0; a > s; s++)for (var l = s; a > l; l++) {
                var h = t[s][l];
                if (0 !== h) {
                    var d = o.nodes[s], c = o.nodes[l], p = o.addEdge(d, c, {});
    ...
    var n, a = e("./forceLayoutWorker"), o = e("zrender/tool/vector"), s = window.requestAnimationFrame || window.msRequestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || function (e) {
            setTimeout(e, 16)
        }, r = "undefined" == typeof Float32Array ? Array : Float32Array, l = function (e) {
    ...
    return l.prototype.updateConfig = function () {
        ...
        if (this._layoutWorker) {
            var t = new Float32Array(e.data), i = t[0];
            if (i === this._token) {
    ...
    if (i.prototype.beforeUpdate = function () {
            ...
            if (!t) {
                var n = (i[0] + i[2]) / 2, a = (i[1] + i[3]) / 2, o = (i[2] - i[0]) / 2, s = (i[3] - i[1]) / 2, r = e.position[0] >= n ? 1 : 0, l = e.position[1] >= a ? 1 : 0, t = this._newSubRegion();
            ...
            for (var n = "undefined" != typeof t, o = 0; i > o; o++) {
                var s = e[2 * o], r = e[2 * o + 1], l = this.nodes[s], h = this.nodes[r];
                if (l && h) {
            ...
            for (var e = this.nodes.length, t = s.create(), i = 0; e > i; i++) {
                ...
                var o = s.len(n.force) + .1, r = Math.min(o, 500) / o;
                ...
                var d = s.len(a), r = Math.min(d, 100) / (d + .1);
            ...
            return function (t, i, n) {
                if (t !== i && (0 !== t.mass || 0 !== i.mass)) {
                    ...
                    if (0 !== a) {
                        var o, r = t.mass + i.mass, l = Math.sqrt(a);
            ...
            var e = s.create(), t = s.create(), i = s.create();
            return function (n, a) {
                var o = n.node1, r = n.node2;
                if (o !== a && r !== a) {
                    ...
                    if (!(0 > h || h > l)) {
                        ...
                        var d = s.dist(i, a.position) - a.size, c = this.edgeToNodeRepulsionFactor(a.mass, Math.max(d, .1), 100);
        ...
        self.onmessage = function (e) {
            if (e.data instanceof ArrayBuffer) {
                ...
                case"update":
                    var r = e.data.steps;
                    if (h) {
                        var i = h.nodes.length, t = new Float32Array(2 * i + 1);
