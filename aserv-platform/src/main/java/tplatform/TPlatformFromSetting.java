...
public class TPlatformFromSetting implements org.apache.thrift.TBase<TPlatformFromSetting, TPlatformFromSetting._Fields>, java.io.Serializable, Cloneable, Comparable<TPlatformFromSetting> {

    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TPlatformFromSetting");
    ...
    // optional
    protected TFromSetting setting;
    ...
    static {
        schemes.put(StandardScheme.class, new TPlatformFromSettingStandardSchemeFactory());
        schemes.put(TupleScheme.class, new TPlatformFromSettingTupleSchemeFactory());
    }
    ...
    static {
        ...
        tmpMap.put(_Fields.SETTING, new org.apache.thrift.meta_data.FieldMetaData("setting", org.apache.thrift.TFieldRequirementType.OPTIONAL, new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRUCT, "TFromSetting")));
        metaDataMap = Collections.unmodifiableMap(tmpMap);
        org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TPlatformFromSetting.class, metaDataMap);
    }

    public TPlatformFromSetting() {
    }

    public TPlatformFromSetting(int fromId, boolean review) {
        this();
        this.fromId = fromId;
        setFromIdIsSet(true);
        this.review = review;
   ...
   */
    public TPlatformFromSetting(TPlatformFromSetting other) {
    ...
    public TPlatformFromSetting deepCopy() {
        return new TPlatformFromSetting(this);
    }
    ...
    public TPlatformFromSetting setFromId(int fromId) {
        this.fromId = fromId;
        setFromIdIsSet(true);
        return this;
    }
    ...
    public TPlatformFromSetting setReview(boolean review) {
        this.review = review;
        setReviewIsSet(true);
        return this;
    }
    ...
    public TFromSetting getSetting() {
        return this.setting;
    }

    public TPlatformFromSetting setSetting(TFromSetting setting) {
    ...
    public boolean equals(Object that) {
        if (that == null)
            return false;
        if (that instanceof TPlatformFromSetting)
            return this.equals((TPlatformFromSetting) that);
        return false;
    }

    public boolean equals(TPlatformFromSetting that) {
        if (that == null)
            return false;
    ...
    @Override
    public int compareTo(TPlatformFromSetting other) {
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("TPlatformFromSetting(");
        boolean first = true;
        sb.append("fromId:");
    ...
    private static class TPlatformFromSettingStandardSchemeFactory implements SchemeFactory {

        public TPlatformFromSettingStandardScheme getScheme() {
            return new TPlatformFromSettingStandardScheme();
        }
    }

    private static class TPlatformFromSettingStandardScheme extends StandardScheme<TPlatformFromSetting> {

        public void read(org.apache.thrift.protocol.TProtocol iprot, TPlatformFromSetting struct) throws org.apache.thrift.TException {
                ...
                switch(schemeField.id) {
                    ...
                    3:
                        if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                            struct.setting = new TFromSetting();
        ...
        public void write(org.apache.thrift.protocol.TProtocol oprot, TPlatformFromSetting struct) throws org.apache.thrift.TException {
            struct.validate();
    ...
    private static class TPlatformFromSettingTupleSchemeFactory implements SchemeFactory {

        public TPlatformFromSettingTupleScheme getScheme() {
            return new TPlatformFromSettingTupleScheme();
        }
    }

    private static class TPlatformFromSettingTupleScheme extends TupleScheme<TPlatformFromSetting> {

        @Override
        public void write(org.apache.thrift.protocol.TProtocol prot, TPlatformFromSetting struct) throws org.apache.thrift.TException {
        ...
        @Override
        public void read(org.apache.thrift.protocol.TProtocol prot, TPlatformFromSetting struct) throws org.apache.thrift.TException {
    ...
    public TPlatformFromSetting create() {
        return new TPlatformFromSetting();
    }

    public TPlatformFromSetting clone() {
        return cloneDepth(0);
    }

    public TPlatformFromSetting cloneDepth(int _depth) {
        TPlatformFromSetting _clone = create();
        _clone.fromId = fromId;
        _clone.review = review;
        int _nextDepth = _depth - 1;
        _clone.setting = _nextDepth < 0 ? setting : setting.cloneDepth(_nextDepth);
        _clone.__isset_bitfield = __isset_bitfield;
        cloneMore(_clone, _depth);
        return _clone;
    }

    public void cloneMore(TPlatformFromSetting _clone, int _depth) {
    }
}
