...
public class TIdentityResult implements org.apache.thrift.TBase<TIdentityResult, TIdentityResult._Fields>, java.io.Serializable, Cloneable, Comparable<TIdentityResult> {

    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TIdentityResult");
    ...
    static {
        schemes.put(StandardScheme.class, new TIdentityResultStandardSchemeFactory());
        schemes.put(TupleScheme.class, new TIdentityResultTupleSchemeFactory());
    }
    ...
    static {
        ...
        org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TIdentityResult.class, metaDataMap);
    }

    public TIdentityResult() {
    }

    public TIdentityResult(long userId, String sessionId) {
        this();
        this.userId = userId;
        setUserIdIsSet(true);
   ...
   */
    public TIdentityResult(TIdentityResult other) {
    ...
    public TIdentityResult deepCopy() {
        return new TIdentityResult(this);
    }
    ...
    public TIdentityResult setUserId(long userId) {
        this.userId = userId;
        setUserIdIsSet(true);
        return this;
    }
    ...
    public TIdentityResult setUserData(String userData) {
    ...
    public TIdentityResult setSessionId(String sessionId) {
        this.sessionId = sessionId;
        return this;
    }
    ...
    public TIdentityResult setServerIds(List<Long> serverIds) {
    ...
    public boolean equals(Object that) {
        if (that == null)
            return false;
        if (that instanceof TIdentityResult)
            return this.equals((TIdentityResult) that);
        return false;
    }

    public boolean equals(TIdentityResult that) {
        if (that == null)
            return false;
    ...
    @Override
    public int compareTo(TIdentityResult other) {
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("TIdentityResult(");
        boolean first = true;
        sb.append("userId:");
    ...
    private static class TIdentityResultStandardSchemeFactory implements SchemeFactory {

        public TIdentityResultStandardScheme getScheme() {
            return new TIdentityResultStandardScheme();
        }
    }

    private static class TIdentityResultStandardScheme extends StandardScheme<TIdentityResult> {

        public void read(org.apache.thrift.protocol.TProtocol iprot, TIdentityResult struct) throws org.apache.thrift.TException {
                        ...
                        if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                            {
                                ...
                                struct.serverIds = new ArrayList<Long>(_list30.size);
                                long _elem31;
                                for (int _i32 = 0; _i32 < _list30.size; ++_i32) {
                                    _elem31 = iprot.readI64();
                                    struct.serverIds.add(_elem31);
                                }
                                iprot.readListEnd();
                            }
        ...
        public void write(org.apache.thrift.protocol.TProtocol oprot, TIdentityResult struct) throws org.apache.thrift.TException {
            struct.validate();
            ...
            if (struct.serverIds != null) {
                if (struct.isSetServerIds()) {
                    oprot.writeFieldBegin(SERVER_IDS_FIELD_DESC);
                    {
                        ...
                        for (long _iter33 : struct.serverIds) {
    ...
    private static class TIdentityResultTupleSchemeFactory implements SchemeFactory {

        public TIdentityResultTupleScheme getScheme() {
            return new TIdentityResultTupleScheme();
        }
    }

    private static class TIdentityResultTupleScheme extends TupleScheme<TIdentityResult> {

        @Override
        public void write(org.apache.thrift.protocol.TProtocol prot, TIdentityResult struct) throws org.apache.thrift.TException {
            ...
            if (struct.isSetServerIds()) {
                {
                    ...
                    for (long _iter34 : struct.serverIds) {
        ...
        @Override
        public void read(org.apache.thrift.protocol.TProtocol prot, TIdentityResult struct) throws org.apache.thrift.TException {
            ...
            if (incoming.get(3)) {
                {
                    ...
                    struct.serverIds = new ArrayList<Long>(_list35.size);
                    long _elem36;
                    for (int _i37 = 0; _i37 < _list35.size; ++_i37) {
                        _elem36 = iprot.readI64();
                        struct.serverIds.add(_elem36);
                    }
                }
                struct.setServerIdsIsSet(true);
            }
    ...
    public TIdentityResult create() {
        return new TIdentityResult();
    }

    public TIdentityResult clone() {
        return cloneDepth(0);
    }

    public TIdentityResult cloneDepth(int _depth) {
        TIdentityResult _clone = create();
    ...
    public void cloneMore(TIdentityResult _clone, int _depth) {
    }
}
