...
public class DOrderInfo implements org.apache.thrift.TBase<DOrderInfo, DOrderInfo._Fields>, java.io.Serializable, Cloneable, Comparable<DOrderInfo>, IThrift {
    ...
    private static final org.apache.thrift.protocol.TField TRADE_DATA_FIELD_DESC = new org.apache.thrift.protocol.TField("tradeData", org.apache.thrift.protocol.TType.I32, (short) 12);

    private static final org.apache.thrift.protocol.TField MORE_DATAS_FIELD_DESC = new org.apache.thrift.protocol.TField("moreDatas", org.apache.thrift.protocol.TType.LIST, (short) 13);
    ...
    private static final int __TRADEDATA_ISSET_ID = 7;

    protected byte __isset_bitfield = 0;

    private static final _Fields optionals[] = { _Fields.PREPARE, _Fields.CONFIGURE_ID, _Fields.PLATFORM, _Fields.PLATFORM_DATA, _Fields.GOODS_ID, _Fields.GOODS_NUMBER, _Fields.AMOUNT, _Fields.USER_ID, _Fields.SERVER_ID, _Fields.PLAYER_ID, _Fields.SHORT_TRADE_ID, _Fields.TRADE_DATA, _Fields.MORE_DATAS };
   ...
   */
    ...
    public DOrderInfo setTradeData(int tradeData) {
        this.tradeData = tradeData;
        setTradeDataIsSet(true);
        return this;
    }

    public void unsetTradeData() {
        __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __TRADEDATA_ISSET_ID);
    }

    /** Returns true if field tradeData is set (has been assigned a value) and false otherwise */
    @JsonIgnore
    public boolean isSetTradeData() {
        return EncodingUtils.testBit(__isset_bitfield, __TRADEDATA_ISSET_ID);
    }

    public void setTradeDataIsSet(boolean value) {
        __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __TRADEDATA_ISSET_ID, value);
    }
    ...
    public boolean equals(DOrderInfo that) {
        ...
        if (this_present_tradeData || that_present_tradeData) {
            if (!(this_present_tradeData && that_present_tradeData))
                return false;
            if (this.tradeData != that.tradeData)
                return false;
        }
    ...
    private static class DOrderInfoStandardScheme extends StandardScheme<DOrderInfo> {
        ...
        public void read(org.apache.thrift.protocol.TProtocol iprot, DOrderInfo struct) throws org.apache.thrift.TException {
            ...
            while (true) {
                ...
                switch(schemeField.id) {
                    ...
                    12:
                        if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
                            struct.tradeData = iprot.readI32();
        ...
        public void write(org.apache.thrift.protocol.TProtocol oprot, DOrderInfo struct) throws org.apache.thrift.TException {
            ...
            if (struct.isSetTradeData()) {
                ...
                oprot.writeI32(struct.tradeData);
                oprot.writeFieldEnd();
            }
    ...
    static {
        ...
        tmpMap.put(_Fields.TRADE_DATA, new org.apache.thrift.meta_data.FieldMetaData("tradeData", org.apache.thrift.TFieldRequirementType.OPTIONAL, new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
    ...
    public DOrderInfo cloneDepth(int _depth) {
        ...
        _clone.setPrepare(prepare);
        _clone.setConfigureId(configureId);
        _clone.setPlatform(platform);
        _clone.setPlatformData(platformData);
        _clone.setGoodsId(goodsId);
        _clone.setGoodsNumber(goodsNumber);
        _clone.setAmount(amount);
        _clone.setUserId(userId);
        _clone.setServerId(serverId);
        _clone.setPlayerId(playerId);
        _clone.setShortTradeId(shortTradeId);
