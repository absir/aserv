...
public class DPlatformFrom implements org.apache.thrift.TBase<DPlatformFrom, DPlatformFrom._Fields>, java.io.Serializable, Cloneable, Comparable<DPlatformFrom> {
    ...
    @JaColum(indexs = { @Index(columnList = "platform,channel,packageName,versionDouble,fromStr") })
