...
public class TLoginResult implements org.apache.thrift.TBase<TLoginResult, TLoginResult._Fields>, java.io.Serializable, Cloneable, Comparable<TLoginResult> {
    ...
    static {
        schemes.put(StandardScheme.class, new TLoginResultStandardSchemeFactory());
        schemes.put(TupleScheme.class, new TLoginResultTupleSchemeFactory());
    }
    ...
    static {
        ...
        tmpMap.put(_Fields.ERROR, new org.apache.thrift.meta_data.FieldMetaData("error", org.apache.thrift.TFieldRequirementType.OPTIONAL, new org.apache.thrift.meta_data.EnumMetaData(org.apache.thrift.protocol.TType.ENUM, LoginError.class)));
   ...
   * @see LoginError
   */
    public TLoginResult setError(LoginError error) {
        this.error = error;
        return this;
    }
    ...
    public TLoginResult setResult(TIdentityResult result) {
        this.result = result;
        return this;
    }
    ...
    private static class TLoginResultStandardSchemeFactory implements SchemeFactory {
    ...
    private static class TLoginResultStandardScheme extends StandardScheme<TLoginResult> {
                ...
                switch(schemeField.id) {
                    ...
                    1:
                        if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
                            struct.error = tplatform.LoginError.findByValue(iprot.readI32());
    ...
    private static class TLoginResultTupleSchemeFactory implements SchemeFactory {
    ...
    private static class TLoginResultTupleScheme extends TupleScheme<TLoginResult> {
    ...
    public TLoginResult create() {
        return new TLoginResult();
    }

    public TLoginResult clone() {
        return cloneDepth(0);
    }

    public TLoginResult cloneDepth(int _depth) {
        TLoginResult _clone = create();
        _clone.error = error;
    ...
    public void cloneMore(TLoginResult _clone, int _depth) {
    }
}
