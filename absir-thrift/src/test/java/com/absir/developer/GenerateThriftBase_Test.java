...
public class GenerateThriftBase_Test {
    ...
    public void test() throws Exception {
        ...
        HelperIO.execute("thrift --gen java ./target/test-classes/thrift/tbase_test.thrift");
        HelperIO.execute("mv -f gen-java ./target/test-classes/thrift/");
        ThriftJavaMerger javaMerger = new ThriftJavaMerger();
        javaMerger.mergeBaseDir(new File(classPath + "/thrift/gen-java"), new File(classPath + "../../src/test/java"));
    }
