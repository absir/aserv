...
public class Pag {
	 ...
	 * @throws IOException
	 */
	public static String include(String include, String generate) throws IOException {
		return getIncludeGen(include, generate, ServerDiyView.getRenders(OnPut.get().getInput()));
	}
