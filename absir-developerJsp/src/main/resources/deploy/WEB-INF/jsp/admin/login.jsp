		...
		<div class="login_box">
			...
			<form class="login_form" role="form" method="post">
				<div class="form-group">
    				<label for="j_username" class="t">用户名：</label> <input id="j_username" name="username" type="text" class="form-control x319 in" autocomplete="off" required>
    			</div>
    			<div class="form-group">
    				<label for="j_password" class="t">密　码：</label> <input id="j_password" name="password" type="password" class="form-control x319 in" required>
    			</div>
    			<div class="form-group">
    				<label for="j_captcha" class="t">验证码：</label> <input id="j_captcha" name="verifycode" type="text" class="form-control x164 in" required>
				...
				<p class="text-center">
					<a href="${SITE_ROUTE}/forget.html"><small>忘记密码了？</small></a> | <a href="${SITE_ROUTE}/register.html">注册一个新账号</a>
				</p>
			</form>
		</div>
	</div>