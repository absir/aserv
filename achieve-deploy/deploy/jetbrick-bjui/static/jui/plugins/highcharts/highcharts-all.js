        ...
        r(d, "getCoordinates", function (a, b) {
            ...
            c.polar ? s(c.axes, function (a) {
                ...
                d[e ? "xAxis" : "yAxis"].push({
                    axis: a, value: a.translate(e ? Math.PI - Math.atan2(g, f) : Math.sqrt(Math.pow(g, 2) + Math.pow(f,
                            2)), !0)
                })
            }) : d = a.call(this, b);
            return d
...
(function (d) {
    ...
    d.SVGRenderer.prototype.cuboidPath = function (d) {
        var a = d.x, b = d.y, c = d.z, e = d.height, f = d.width, j = d.depth, i = d.alpha, h = d.beta, a = [{
            ...
            y: b,
            z: c
        }, {x: a + f, y: b, z: c}, {x: a + f, y: b + e, z: c}, {x: a, y: b + e, z: c}, {x: a, y: b + e, z: c + j}, {
            x: a + f, y: b + e, z: c +
            j
        }, {x: a + f, y: b, z: c + j}, {
            x: a,
        ...
        return [["M", a[0].x, a[0].y, "L", a[1].x, a[1].y, "L", a[2].x, a[2].y, "L", a[3].x, a[3].y, "Z"], a[7].y < a[1].y ? d : a[4].y > a[2].y ? b : [], a[6].x >
    ...
    d.SVGRenderer.prototype.arc3d = function (g) {
        ...
        a.animate = function (a, b, c) {
            a.end || a.start ? (this._shapeArgs = this.shapeArgs, d.SVGElement.prototype.animate.call(this, {_args: a}, {
    ...
    var y = d.getOptions();
    y.chart.options3d = {
        enabled: !1, alpha: 0, beta: 0, depth: 100, viewDistance: 25, frame: {
            bottom: {size: 1, color: "rgba(255,255,255,0)"}, side: {size: 1, color: "rgba(255,255,255,0)"},
    ...
    d.wrap(d.Axis.prototype, "render",
        function (d) {
            d.apply(this, [].slice.call(arguments, 1));
            if (this.chart.is3d()) {
                var a = this.chart, b = a.renderer, c = a.options.chart.options3d, e = c.alpha, f = c.beta * (a.yAxis[0].opposite ? -1 : 1), j = c.frame, i = j.bottom, h = j.back, j = j.side, k = c.depth, o = this.height, q = this.width, l = this.left, m = this.top, c = {
    ...
    d.wrap(d.Tick.prototype, "getLabelPosition",
        function (d) {
            ...
            c *= b.yAxis[0].opposite ? -1 : 1;
            return a = x([{x: a.x, y: a.y, z: 0}], f, c, e)[0]
        });
    ...
    d.wrap(d.seriesTypes.column.prototype, "translate", function (g) {
        g.apply(this, [].slice.call(arguments, 1));
        if (this.chart.is3d()) {
            var a = this.chart, b = this.options, c = a.options.chart.options3d, e = b.depth || 25, f = {
                x: a.plotWidth / 2,
                y: a.plotHeight / 2,
                z: c.depth,
                vd: c.viewDistance
    ...
    d.wrap(d.seriesTypes.cylinder.prototype, "translate", function (g) {
        g.apply(this, [].slice.call(arguments, 1));
        if (this.chart.is3d()) {
            var a = this.chart, b = a.options, c = b.plotOptions.cylinder, b = b.chart.options3d, e = c.depth || 0, f = {
                x: a.inverted ? a.plotHeight / 2 : a.plotWidth / 2, y: a.inverted ? a.plotWidth /
    ...
    d.wrap(d.seriesTypes.pie.prototype, "translate", function (g) {
        ...
        if (this.chart.is3d()) {
            var a = this, b = a.chart, c = a.options, e = c.depth || 0, f =
                b.options.chart.options3d, j = {
                x: b.plotWidth / 2,
                y: b.plotHeight / 2,
                z: f.depth
            }, i = f.alpha, h = f.beta, k = c.stacking ? (c.stack || 0) * e : a._i * e;
            k += e / 2;
            c.grouping !== !1 && (k = 0);
    ...
    d.wrap(d.seriesTypes.scatter.prototype, "translate",
        function (g) {
            g.apply(this, [].slice.call(arguments, 1));
            if (this.chart.is3d()) {
                var a = this.chart, b = this.chart.options.chart.options3d, c = b.alpha, e = b.beta, f = {
